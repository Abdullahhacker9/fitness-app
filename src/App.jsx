...
export default function App() {
  ...
  const EXERCISES = [
    ...
    { name: 'Barbell Bent-Over Row', category: 'Back', equipment: 'Barbell' },
    { name: 'Dumbbell Bicep Curl', category: 'Arms', equipment: 'Dumbbell' },
    { name: 'Tricep Rope Pushdown', category: 'Arms', equipment: 'Cable' },
  ]
    ...
    return (
      <PromoCode
        ...
        onComplete={(unlocked) => {
          ...
          else alert('🔒 Access locked. Enter a valid promo code.')
        }}
    ...
    <div className="flex min-h-screen bg-black text-zinc-100">
      ...
      <aside className="w-64 border-r border-zinc-800 p-6 flex flex-col justify-between shrink-0">
        ...
        <div className="space-y-2">
          <button
            onClick={() => alert('Mobile PWA QR Code Sync ready.')}
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-6 max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <div className="text-yellow-400 font-black text-xs uppercase mb-1">Logger</div>
                <h3 className="font-black text-zinc-100 text-base uppercase">Log Workout</h3>
                <p className="text-xs text-zinc-500 mt-1">Record live sets, reps, and weight.</p>
              </div>
              ...
              <div
                ...
                className="cursor-pointer rounded-2xl border border-zinc-800 bg-zinc-950 p-5 hover:border-yellow-400/50 transition-all"
              >
                <div className="text-yellow-400 font-black text-xs uppercase mb-1">Nutrition</div>
                <h3 className="font-black text-zinc-100 text-base uppercase">Track Macros</h3>
                <p className="text-xs text-zinc-500 mt-1">Monitor daily calories and protein.</p>
              </div>
              ...
              <div
                ...
                className="cursor-pointer rounded-2xl border border-zinc-800 bg-zinc-950 p-5 hover:border-yellow-400/50 transition-all"
              >
                <div className="text-yellow-400 font-black text-xs uppercase mb-1">Settings</div>
                <h3 className="font-black text-zinc-100 text-base uppercase">Targets & Goals</h3>
                <p className="text-xs text-zinc-500 mt-1">Update target weight and calorie goals.</p>
              </div>
            </div>
          </div>
        )}
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-950 p-6 shadow-xl">
              ...
              <div className="grid grid-cols-3 gap-4 text-center mb-6">
                <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-4">
                  <div className="text-xl font-black text-yellow-400">0 / 2500</div>
                  <div className="text-[10px] text-zinc-500 font-bold uppercase mt-1">Calories</div>
                </div>
                <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-4">
                  <div className="text-xl font-black text-yellow-400">0g / 180g</div>
                  <div className="text-[10px] text-zinc-500 font-bold uppercase mt-1">Protein</div>
                </div>
                <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-4">
                  <div className="text-xl font-black text-yellow-400">0g / 250g</div>
        ...
        {activeTab === 'analytics' && (
          <div className="max-w-2xl space-y-6">
            <div className="rounded-2xl border border-zinc-800 bg-zinc-950 p-6 shadow-xl">
              ...
              <p className="text-xs text-zinc-400 mb-6">Personal records automatically update as you log workouts.</p>

              <div className="space-y-3">
                {[
                  { name: 'Bench Press', weight: '100 kg' },
                  { name: 'Squat', weight: '140 kg' },
                  { name: 'Deadlift', weight: '180 kg' },
                  { name: 'Overhead Press', weight: '70 kg' },
                ].map((pr, idx) => (
                  <div key={idx} className="rounded-xl border border-zinc-900 bg-zinc-900/50 p-4 flex justify-between items-center">
                    ...
                    <span className="text-xs font-mono text-yellow-400 font-bold">{pr.weight}</span>
                  </div>
                ))}
              </div>
            </div>
